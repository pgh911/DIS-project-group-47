...
## About the project
We have implemented a budget app. The ER diagram can be found in /docs. The RegEx can be found in the /register page, where we recognize an email on the form of [user]@group47.[domain] and [user]@gruppe47.[domain]. 
